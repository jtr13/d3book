...
2. Download a copy of [`shapes.html`](https://raw.githubusercontent.com/jtr13/d3book/master/code/shapes.html){target="_blank"}. Open the previous link, right click -> Save As -> Add .html to the end of the file name.
