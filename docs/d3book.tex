...
\NormalTok{svg}\OperatorTok{.}\FunctionTok{append}\NormalTok{(}\StringTok{"g"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"id"}\OperatorTok{,} \StringTok{"xaxis"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \StringTok{"translate(0,"} \OperatorTok{+}\NormalTok{ (h }\OperatorTok{{-}}\NormalTok{ padding) }\OperatorTok{+} \StringTok{")"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{call}\NormalTok{(xAxis)}\OperatorTok{;}

\CommentTok{// create Y axis}
\NormalTok{svg}\OperatorTok{.}\FunctionTok{append}\NormalTok{(}\StringTok{"g"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"id"}\OperatorTok{,} \StringTok{"yaxis"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \StringTok{"translate("} \OperatorTok{+}\NormalTok{ padding }\OperatorTok{+} \StringTok{",0)"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{call}\NormalTok{(yAxis)}\OperatorTok{;}
...
\NormalTok{svg}\OperatorTok{.}\FunctionTok{append}\NormalTok{(}\StringTok{"text"}\NormalTok{)}
  ...
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"y"}\OperatorTok{,}\NormalTok{ h }\OperatorTok{{-}}\NormalTok{ padding }\OperatorTok{/} \DecValTok{2} \OperatorTok{+} \DecValTok{10}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"text{-}anchor"}\OperatorTok{,} \StringTok{"middle"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{text}\NormalTok{(}\StringTok{"displacement"}\NormalTok{)}\OperatorTok{;}

\NormalTok{svg}\OperatorTok{.}\FunctionTok{append}\NormalTok{(}\StringTok{"text"}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"x"}\OperatorTok{,}\NormalTok{ padding }\OperatorTok{/} \DecValTok{3}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"y"}\OperatorTok{,}\NormalTok{ h }\OperatorTok{/} \DecValTok{2}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \VerbatimStringTok{\textasciigrave{}rotate({-}90, }\SpecialCharTok{$\{}\NormalTok{padding}\OperatorTok{/}\DecValTok{3}\SpecialCharTok{\}}\VerbatimStringTok{, }\SpecialCharTok{$\{}\NormalTok{h}\OperatorTok{/}\DecValTok{2}\SpecialCharTok{\}}\VerbatimStringTok{)\textasciigrave{}}\NormalTok{)}
  \OperatorTok{.}\FunctionTok{text}\NormalTok{(}\StringTok{"mpg"}\NormalTok{)}\OperatorTok{;}
