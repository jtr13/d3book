...
\begin{center}\includegraphics{d3book_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics{d3book_files/figure-latex/unnamed-chunk-31-1} \end{center}
...
\begin{center}\includegraphics{d3book_files/figure-latex/unnamed-chunk-33-1} \end{center}
...
\begin{center}\includegraphics{d3book_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{databind}\NormalTok{.}\AttributeTok{enter}\NormalTok{().}\AttributeTok{append}\NormalTok{(}\StringTok{"text"}\NormalTok{)}
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"x"}\OperatorTok{,}\NormalTok{ d }\OperatorTok{=>} \VariableTok{d}\NormalTok{.}\AttributeTok{x}\NormalTok{)}
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"y"}\OperatorTok{,}\NormalTok{ d }\OperatorTok{=>} \VariableTok{d}\NormalTok{.}\AttributeTok{y}\NormalTok{)}
\NormalTok{  .}\AttributeTok{text}\NormalTok{(d }\OperatorTok{=>} \VerbatimStringTok{`key: }\SpecialCharTok{$\{}\VariableTok{d}\NormalTok{.}\AttributeTok{key}\SpecialCharTok{\}}\VerbatimStringTok{`}\NormalTok{)}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\href{https://blockbuilder.org/}{blockbuilder.org} offers a convenient option, with good documentation, for sharing D3 examples online. You can also \href{https://blockbuilder.org/search}{search blockbuilder} for examples. Remember to pay attention to the version of D3 in use; some authors are including v5 in the block titles but this practice is not widespread. Remember as well that not all examples are good examples, both in terms of the graph choices and the quality of the code.
...
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"y"}\OperatorTok{,}\NormalTok{ h }\OperatorTok{-}\NormalTok{ padding / }\DecValTok{2} \OperatorTok{+} \DecValTok{10}\NormalTok{)}
...
\VariableTok{svg}\NormalTok{.}\AttributeTok{append}\NormalTok{(}\StringTok{"text"}\NormalTok{)}
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"x"}\OperatorTok{,}\NormalTok{ padding / }\DecValTok{3}\NormalTok{)}
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"y"}\OperatorTok{,}\NormalTok{ h / }\DecValTok{2}\NormalTok{)}
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \VerbatimStringTok{`rotate(-90, }\SpecialCharTok{$\{}\NormalTok{padding/}\DecValTok{3}\SpecialCharTok{\}}\VerbatimStringTok{, }\SpecialCharTok{$\{}\NormalTok{h/}\DecValTok{2}\SpecialCharTok{\}}\VerbatimStringTok{)`}\NormalTok{)}
...
\NormalTok{        fill: }\DecValTok{none}\NormalTok{;}
\NormalTok{        stroke: }\DecValTok{red}\NormalTok{;}
\NormalTok{        stroke-width: }\DecValTok{1.5px}\NormalTok{;}
\NormalTok{      \}}
        \KeywordTok{</style>}
    \KeywordTok{</head>}
    \KeywordTok{<body>}
    \KeywordTok{<svg}\OtherTok{ width=}\StringTok{"600"}\OtherTok{ height=}\StringTok{"400"}\KeywordTok{></svg>}
    \KeywordTok{<script>}
      \KeywordTok{var}\NormalTok{ svg }\OperatorTok{=} \VariableTok{d3}\NormalTok{.}\AttributeTok{select}\NormalTok{(}\StringTok{"svg"}\NormalTok{)}
      \KeywordTok{var}\NormalTok{ margin }\OperatorTok{=} \OperatorTok{\{}\DataTypeTok{top}\OperatorTok{:} \DecValTok{20}\OperatorTok{,} \DataTypeTok{right}\OperatorTok{:} \DecValTok{50}\OperatorTok{,} \DataTypeTok{bottom}\OperatorTok{:} \DecValTok{30}\OperatorTok{,} \DataTypeTok{left}\OperatorTok{:} \DecValTok{50}\OperatorTok{\}}
      \KeywordTok{var}\NormalTok{ width }\OperatorTok{=}  \OperatorTok{+}\VariableTok{svg}\NormalTok{.}\AttributeTok{attr}\NormalTok{(}\StringTok{"width"}\NormalTok{) }\OperatorTok{-} \VariableTok{margin}\NormalTok{.}\AttributeTok{left} \OperatorTok{-} \VariableTok{margin}\NormalTok{.}\AttributeTok{right}
      \KeywordTok{var}\NormalTok{ height }\OperatorTok{=} \OperatorTok{+}\VariableTok{svg}\NormalTok{.}\AttributeTok{attr}\NormalTok{(}\StringTok{"height"}\NormalTok{) }\OperatorTok{-} \VariableTok{margin}\NormalTok{.}\AttributeTok{top} \OperatorTok{-} \VariableTok{margin}\NormalTok{.}\AttributeTok{bottom}
      \KeywordTok{var}\NormalTok{ g }\OperatorTok{=} \VariableTok{svg}\NormalTok{.}\AttributeTok{append}\NormalTok{(}\StringTok{"g"}\NormalTok{).}\AttributeTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \VerbatimStringTok{`translate(}\SpecialCharTok{$\{}\VariableTok{margin}\NormalTok{.}\AttributeTok{left}\SpecialCharTok{\}}\VerbatimStringTok{, }\SpecialCharTok{$\{}\VariableTok{margin}\NormalTok{.}\AttributeTok{top}\SpecialCharTok{\}}\VerbatimStringTok{)`}\NormalTok{)}\OperatorTok{;}
      \KeywordTok{var}\NormalTok{ parseTime }\OperatorTok{=} \VariableTok{d3}\NormalTok{.}\AttributeTok{timeParse}\NormalTok{(}\StringTok{"%d-%b-%y"}\NormalTok{)}\OperatorTok{;}
...
\NormalTok{      xScale}
\NormalTok{        .}\AttributeTok{domain}\NormalTok{(}\VariableTok{d3}\NormalTok{.}\AttributeTok{extent}\NormalTok{(data}\OperatorTok{,}\NormalTok{ d }\OperatorTok{=>} \VariableTok{d}\NormalTok{.}\AttributeTok{date}\NormalTok{))}\OperatorTok{;}
        
      \VariableTok{g}\NormalTok{.}\AttributeTok{append}\NormalTok{(}\StringTok{"g"}\NormalTok{)}
\NormalTok{          .}\AttributeTok{attr}\NormalTok{(}\StringTok{"transform"}\OperatorTok{,} \VerbatimStringTok{`translate(0, }\SpecialCharTok{$\{}\NormalTok{height}\SpecialCharTok{\}}\VerbatimStringTok{)`}\NormalTok{)}
\NormalTok{          .}\AttributeTok{call}\NormalTok{(}\VariableTok{d3}\NormalTok{.}\AttributeTok{axisBottom}\NormalTok{(xScale).}\AttributeTok{ticks}\NormalTok{(}\DecValTok{7}\NormalTok{))}\OperatorTok{;}
      \VariableTok{g}\NormalTok{.}\AttributeTok{append}\NormalTok{(}\StringTok{"g"}\NormalTok{)}
\NormalTok{          .}\AttributeTok{call}\NormalTok{(}\VariableTok{d3}\NormalTok{.}\AttributeTok{axisLeft}\NormalTok{(yScale))}
      \VariableTok{g}\NormalTok{.}\AttributeTok{append}\NormalTok{(}\StringTok{"path"}\NormalTok{)}
\NormalTok{          .}\AttributeTok{datum}\NormalTok{(data)}
\NormalTok{          .}\AttributeTok{attr}\NormalTok{(}\StringTok{"class"}\OperatorTok{,} \StringTok{"line"}\NormalTok{)}
\NormalTok{          .}\AttributeTok{attr}\NormalTok{(}\StringTok{"fill"}\OperatorTok{,} \StringTok{"none"}\NormalTok{)}
\NormalTok{          .}\AttributeTok{attr}\NormalTok{(}\StringTok{"d"}\OperatorTok{,}\NormalTok{ line)}\OperatorTok{;}
    \KeywordTok{</script>}
    \KeywordTok{</body>}
\KeywordTok{</html>}
\end{Highlighting}
