...
Open the bar chart you created in the previous exercise in Chrome, or \href{code/barchart1.html}{this one} and work in the Console. (You don't have to download it.)
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var}\NormalTok{ array_dataset }\OperatorTok{=}\NormalTok{ [[}\DecValTok{100}\OperatorTok{,} \DecValTok{200}\OperatorTok{,} \DecValTok{40}\NormalTok{]}\OperatorTok{,}\NormalTok{ [}\DecValTok{300}\OperatorTok{,} \DecValTok{150}\OperatorTok{,} \DecValTok{20}\NormalTok{]]}\OperatorTok{;}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var}\NormalTok{ object_dataset }\OperatorTok{=}\NormalTok{ [ }\OperatorTok{\{}
    \DataTypeTok{cx}\OperatorTok{:} \DecValTok{100}\OperatorTok{,}
    \DataTypeTok{cy}\OperatorTok{:} \DecValTok{200}\OperatorTok{,}
    \DataTypeTok{fill}\OperatorTok{:} \VerbatimStringTok{`red`}
  \OperatorTok{\},}
  \OperatorTok{\{}
    \DataTypeTok{cx}\OperatorTok{:} \DecValTok{300}\OperatorTok{,}
    \DataTypeTok{cy}\OperatorTok{:} \DecValTok{100}\OperatorTok{,}
    \DataTypeTok{fill}\OperatorTok{:} \VerbatimStringTok{`blue`}
...
\NormalTok{  .}\AttributeTok{attr}\NormalTok{(}\StringTok{"r"}\OperatorTok{,} \StringTok{"50"}\NormalTok{)}
...
Take \emph{one data value}, return one value.

\url{https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math\#Methods}

\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{Math}\NormalTok{.}\AttributeTok{sqrt}\NormalTok{(}\DecValTok{3}\NormalTok{)}\OperatorTok{;}

\KeywordTok{var}\NormalTok{ x }\OperatorTok{=}\NormalTok{ [}\DecValTok{3}\OperatorTok{,} \DecValTok{5}\OperatorTok{,} \DecValTok{7}\NormalTok{]}\OperatorTok{;}

\VariableTok{Math}\NormalTok{.}\AttributeTok{sqrt}\NormalTok{(x)}\OperatorTok{;} \CommentTok{// oops, it's not R}

\NormalTok{Math}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}

\texttt{map()} to the rescue

Use map to operate on each array element separately.

Analogy:

R list:\texttt{lapply()} :: JavaScript array:\texttt{.map()}

(What is the tidyverse equivalent of \texttt{lapply()}? \texttt{map()}!!!!!!)
...
\VariableTok{x}\NormalTok{.}\AttributeTok{map}\NormalTok{(d }\OperatorTok{=>}\NormalTok{ d}\OperatorTok{*}\DecValTok{3}\NormalTok{)}\OperatorTok{;}

\VariableTok{x}\NormalTok{.}\AttributeTok{map}\NormalTok{(}\KeywordTok{function}\NormalTok{(d) }\OperatorTok{\{}\ControlFlowTok{return}\NormalTok{ d}\OperatorTok{*}\DecValTok{3}\OperatorTok{;\}}\NormalTok{)}\OperatorTok{;}

\NormalTok{[}\DecValTok{10}\OperatorTok{,} \DecValTok{20}\OperatorTok{,} \DecValTok{30}\OperatorTok{,} \DecValTok{40}\NormalTok{].}\AttributeTok{map}\NormalTok{((d}\OperatorTok{,}\NormalTok{ i) }\OperatorTok{=>}\NormalTok{ d}\OperatorTok{*}\NormalTok{i)}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}

My nested array language:

{[}\emph{element1, element2}{]}

\emph{element1} = {[}\emph{item1, item2, item3}{]}

\emph{element2} = {[}\emph{item1, item2, item3}{]}

Do something to the first item of every element of a nested array:

\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{array_dataset}\NormalTok{.}\AttributeTok{map}\NormalTok{(d }\OperatorTok{=>} \VariableTok{Math}\NormalTok{.}\AttributeTok{sqrt}\NormalTok{(d[}\DecValTok{0}\NormalTok{]))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{array_dataset}\NormalTok{.}\AttributeTok{map}\NormalTok{(d }\OperatorTok{=>}\NormalTok{ d[}\DecValTok{0}\NormalTok{] }\OperatorTok{+}\NormalTok{ d[}\DecValTok{1}\NormalTok{] }\OperatorTok{+}\NormalTok{ d[}\DecValTok{2}\NormalTok{])}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{10}\OperatorTok{,} \DecValTok{20}\OperatorTok{,} \DecValTok{30}\NormalTok{].}\AttributeTok{map}\NormalTok{((d}\OperatorTok{,}\NormalTok{ i) }\OperatorTok{=>}\NormalTok{ (}\OperatorTok{\{}\DataTypeTok{index}\OperatorTok{:}\NormalTok{ i}\OperatorTok{,} \DataTypeTok{value}\OperatorTok{:}\NormalTok{ d}\OperatorTok{\}}\NormalTok{))}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
Take \emph{arrays} --\textgreater{} return single values (like R!)

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var}\NormalTok{ x }\OperatorTok{=}\NormalTok{ [}\DecValTok{12}\OperatorTok{,} \DecValTok{34}\OperatorTok{,} \DecValTok{1}\OperatorTok{,} \DecValTok{43}\OperatorTok{,} \DecValTok{90}\OperatorTok{,} \DecValTok{72}\NormalTok{]}\OperatorTok{;}

\VariableTok{d3}\NormalTok{.}\AttributeTok{mean}\NormalTok{(x)}\OperatorTok{;}

\VariableTok{d3}\NormalTok{.}\AttributeTok{sum}\NormalTok{(x)}\OperatorTok{;}

\VariableTok{d3}\NormalTok{.}\AttributeTok{min}\NormalTok{(x)}\OperatorTok{;}

\VariableTok{d3}\NormalTok{.}\AttributeTok{max}\NormalTok{(x)}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{d3}\NormalTok{.}\AttributeTok{extent}\NormalTok{(x)}\OperatorTok{;}\NormalTok{  \textbackslash{}\textbackslash{} Think }\StringTok{"range"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{d3}\NormalTok{.}\AttributeTok{range}\NormalTok{(}\DecValTok{5}\NormalTok{)}\OperatorTok{;}\NormalTok{ \textbackslash{}\textbackslash{} Think}\OperatorTok{:}\NormalTok{ count }\ImportTok{from} \DecValTok{0}\NormalTok{ to n}\DecValTok{-1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var}\NormalTok{ dataset }\OperatorTok{=}\NormalTok{ [[}\DecValTok{100}\OperatorTok{,} \DecValTok{200}\OperatorTok{,} \DecValTok{40}\NormalTok{]}\OperatorTok{,}\NormalTok{ [}\DecValTok{300}\OperatorTok{,} \DecValTok{150}\OperatorTok{,} \DecValTok{20}\NormalTok{]]}\OperatorTok{;}
...
\VariableTok{d3}\NormalTok{.}\AttributeTok{range}\NormalTok{(}\DecValTok{5}\NormalTok{).}\AttributeTok{map}\NormalTok{(d }\OperatorTok{=>}\NormalTok{ [d }\OperatorTok{-} \DecValTok{1}\OperatorTok{,}\NormalTok{ d}\OperatorTok{,}\NormalTok{ d }\OperatorTok{+} \DecValTok{1}\NormalTok{])}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}

\hypertarget{exercise-math}{%
\section{Exercise: : math}\label{exercise-math}}

Use the following to find the sample standard deviation of 3, 5, 7, 8 and 9.

\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{d3}\NormalTok{.}\AttributeTok{sum}\NormalTok{()}
\VariableTok{d3}\NormalTok{.}\AttributeTok{mean}\NormalTok{()}

\VariableTok{Math}\NormalTok{.}\AttributeTok{sqrt}\NormalTok{()}
\VariableTok{Math}\NormalTok{.}\AttributeTok{pow}\NormalTok{()}

\NormalTok{.}\AttributeTok{map}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\subsection{\texorpdfstring{\texttt{d3.scaleBand()}}{d3.scaleBand()}}\label{d3.scaleband}}
...
\subsection{\texorpdfstring{\texttt{d3.scaleLinear()}}{d3.scaleLinear()}}\label{d3.scalelinear}}
