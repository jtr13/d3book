...
\VariableTok{d3}\NormalTok{.}\AttributeTok{select}\NormalTok{(}\StringTok{"div#radio"}\NormalTok{)}
...
\VariableTok{d3}\NormalTok{.}\AttributeTok{select}\NormalTok{(}\StringTok{"div#radio2"}\NormalTok{).}\AttributeTok{selectAll}\NormalTok{(}\StringTok{"input"}\NormalTok{)}
\NormalTok{  .}\AttributeTok{on}\NormalTok{(}\StringTok{"click"}\OperatorTok{,} \KeywordTok{function}\NormalTok{ () }\OperatorTok{\{}
