...
[Chrome browser](https://www.google.com/chrome/){target="_blank"}

### Elements 

1. Open a *downloaded version* of `shapes.html`.

You can obtain a downloaded copy of the file by:

- clicking [here](https://raw.githubusercontent.com/jtr13/d3book/master/code/shapes.html){target="_blank"} and then File, Save Page As...

**or**

- downloading a ZIP of the whole repo by clicking [here](https://github.com/jtr13/d3book/archive/master.zip){target="_blank"}

**or**

- forking and cloning the [repo](https://github.com/jtr13/d3book){target="_blank"}
