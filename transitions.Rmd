...
Download and make changes to [bar_transition.html](https://raw.githubusercontent.com/jtr13/d3book/main/code/bar_transition.html){target="_blank"} in a text editor so the transitions work as shown in the video below. [rendered version](code/bar_transition.html){target="_blank"}
