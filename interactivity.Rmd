...
<div id="radio" style="margin-left: 30px">
...
```{r, echo=FALSE}
if (!knitr::is_html_output()) webshot::webshot("https://jtr13.github.io/d3book/interactivity.html#turn-off-event-listener", selector = "div#radio2")
```

```{asis, echo=knitr::is_html_output()}
<div id="radio2" style="margin-left: 30px">
...
d3.select("div#radio2").selectAll("input")
  .on("click", function () {
