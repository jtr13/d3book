...
In this chapter, we will explore some basic but interesting demonstrations. When going through the section, read the script first before executing it in the console. Think beforehead what will happen when an event listener is triggered and what information you need. 

For the following scripts open Developer Tools and try these in the Console. Note that event management [changed in v6](https://observablehq.com/@d3/d3v6-migration-guide#events){target="_blank"} so code written for earlier versions of D3 will not work. 
...
```
Click on the svg after entering the code into console, what do you observe?
...
We retrieve the radius of the circle after clicking on it.
