...
### Do something with an attribute of the element that received the event
...
### Do something with the svg location of the event
...
<p id="color">Please select your favorite primary color:</p>
