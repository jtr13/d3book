...
Open Developer Tools and copy and paste the code below in the Console. (Click <i class="fa fa-align-justify"></i> above to close the table of contents on the left so you'll have more screen space.)
...
Open the bar chart you created in the previous exercise in Chrome, or [this one](code/barchart1.html){target="_blank"} and work in the Console. (You don't have to download it.)
