...
To follow along with the code in this section, open [six_blue_circles.html](https://jtr13.github.io/d3book/code/six_blue_circles.html)){target="_blank"} in Chrome and work in the JavaScript Console.
...
Open [six_blue_circles.html](https://jtr13.github.io/d3book/code/six_blue_circles.html)){target="_blank"} in Chrome. Open the JavaScript Console and practice binding data to the circles and modifying the circles based on the data as in the examples above.
