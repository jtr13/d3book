...
Copy and paste the following into the Console. What happens? Why?
...
Refresh the page and then copy and paste the following into the Console and run. What changed? Why?
...
Open the bar chart you created in the previous exercise in Chrome, or download and open [this one](code/barchart1.html){target="_blank"} and work in the Console.
