...
- For D3 to work, you must link to a D3 library. To link to the online version, include this line: `<script src="https://cdn.jsdelivr.net/npm/d3@7"></script>`. Alternatively, you can also download a copy from the same site and reference your local copy with:
