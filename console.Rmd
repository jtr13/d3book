...
This section is interactive as scripts are written directly in the markdown page. You can hover over code as directed to observe effects. If you are interested, you can look at the source code to see why the following section is interactive. 
